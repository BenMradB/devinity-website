  ...
  return (
    ...
    >
      <div className="flex flex-row justify-between items-center py-2">
        <div className="ml-2 md:ml-0 flex flex-row justify-center md:px-12 md:mx-12 items-center text-center font-semibold">
          <HashLink smooth to="/#hero">
            <h1 className="font-extrabold text-4xl text-blue-900">
              <Logo className="w-[35pw] h-[35px] md:w-[60pw] md:h-[60px]" />
            </h1>
          </HashLink>
        </div>
